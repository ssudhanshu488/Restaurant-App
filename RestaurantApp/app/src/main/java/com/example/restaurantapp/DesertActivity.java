...
public class DesertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView deserts = findViewById(R.id.list_view_deserts);
        ...
        ArrayAdapter<Dish> desertArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,dishes);
        deserts.setAdapter(desertArrayAdapter);
    }
